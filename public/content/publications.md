...
1. Huang, H., Yang, H., Chen, Y., Ye, J., & Wu, D. (2025). Fedrts: Federated robust pruning via combinatorial thompson sampling. arXiv preprint arXiv:2501.19122.
...
2. Huang, H., Zhuang, W., Chen, C., & Lyu, L. (2024). Fedmef: Towards memory-efficient federated dynamic pruning. In Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (pp. 27548-27557).
...
3. Huang, H., Zhang, L., Sun, C., Fang, R., Yuan, X., & Wu, D. (2023, July). Distributed pruning towards tiny neural networks in federated learning. In 2023 IEEE 43rd International Conference on Distributed Computing Systems (ICDCS) (pp. 190-201). IEEE.
...
4. Hu, J., Yang, Z., Wang, P., Zhao, G., Huang, H., Zong, Z., & Wu, D. O. (2025). Federated learning for medical image analysis: Privacy-preserving paradigms and clinical challenges. Innovations in Water Treatment, 1(1), 153-169.
